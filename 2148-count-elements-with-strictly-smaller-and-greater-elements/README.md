...
<pre style="user-select: auto;"><strong style="user-select: auto;">Input:</strong> nums = [11,7,2,15]
...
<pre style="user-select: auto;"><strong style="user-select: auto;">Input:</strong> nums = [-3,3,3,90]
<strong style="user-select: auto;">Output:</strong> 2
